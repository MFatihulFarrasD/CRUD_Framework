...
<html>
<head>
	<title >TUGAS PBO CRUD PHP & MySQL </title>
	<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
</head>
<body>
<div class="container">

	<H1 class="text-center"> TUGAS PBO CRUD PHP & MySQL </H1>
	<h5 class="text-center">Mohammad Fatihul Farras (20051214102)</h5>
    <p>
	...
	<div class="card mt-5">
      ...
      <?= form_open('mahasiswa/simpandata')?>
	   <form method="post" action="" class=" card-header bg-primary">
